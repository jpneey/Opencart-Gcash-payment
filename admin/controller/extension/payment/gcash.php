...
class ControllerExtensionPaymentGcash extends Controller {
	...
	public function index() {
		...
		$data['payment_gcash_bank'] = array();

		$languages = $this->model_localisation_language->getLanguages();
		
		foreach ($languages as $language) {
			if (isset($this->request->post['payment_gcash_bank' . $language['language_id']])) {
				$data['payment_gcash_bank'][$language['language_id']] = $this->request->post['payment_gcash_bank' . $language['language_id']];
			} else {
				$data['payment_gcash_bank'][$language['language_id']] = $this->config->get('payment_gcash_bank' . $language['language_id']);
			}
		}
	...
	protected function validate() {
		...
		foreach ($languages as $language) {
			if (empty($this->request->post['payment_gcash_bank' . $language['language_id']])) {
